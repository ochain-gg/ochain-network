...
func (tx *RemoveValidatorTransaction) Check(ctx TransactionContext) *abcitypes.ResponseCheckTx {
...
func (tx *RemoveValidatorTransaction) Execute(ctx TransactionContext) *abcitypes.ExecTxResult {
